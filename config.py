...
class DefaultConfig:
    ...
    APP_AZURE_OPENAIAPIKEY= os.environ.get("OPENAI_API_KEY","498e27ca0d0742b4b65f952e67714870") #GPT.35 
    #APP_AZURE_OPENAIAPIKEY= os.environ.get("OPENAI_API_KEY","3d8bc480088f42658ee6e47a0fe0e9d8") #GPT4
